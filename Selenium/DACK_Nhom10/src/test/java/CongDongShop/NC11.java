...
public class NC11 {
    public static void testSelenium(){
        ...
        try{
            ...
            selectOption.selectByVisibleText("Thứ tự theo điểm đánh giá");
            Thread.sleep(4000);

            String strSearch = driver.findElement(By.xpath("//*[@id=\"wrapper\"]/div/div/div[2]/form/select/option[2]")).getText();
            String strSearchResult = "Thứ tự theo điểm đánh giá";
